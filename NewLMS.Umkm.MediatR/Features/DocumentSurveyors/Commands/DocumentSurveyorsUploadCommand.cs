...
{
    public class DocumentSurveyorsUploadCommand : DocumentSurveyorUploadRequest, IRequest<ServiceResponse<Unit>>
    {

    }

    public class DocumentSurveyorsUploadCommandHandler : IRequestHandler<DocumentSurveyorsUploadCommand, ServiceResponse<Unit>>
    {
        ...
        public DocumentSurveyorsUploadCommandHandler(
        ...
        public async Task<ServiceResponse<Unit>> Handle(DocumentSurveyorsUploadCommand command, CancellationToken cancellationToken)
        {
