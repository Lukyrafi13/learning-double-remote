...
{
    public class DocumentSurveyorsDeleteCommand : AppraisalImagesDeleteRequest, IRequest<ServiceResponse<Unit>>
    {
    }

    public class DocumentSurveyorsDeleteCommandHandler : IRequestHandler<DocumentSurveyorsDeleteCommand, ServiceResponse<Unit>>
    {
        ...
        public DocumentSurveyorsDeleteCommandHandler(
        ...
        public async Task<ServiceResponse<Unit>> Handle(DocumentSurveyorsDeleteCommand request, CancellationToken cancellationToken)
        {
            try
            {
