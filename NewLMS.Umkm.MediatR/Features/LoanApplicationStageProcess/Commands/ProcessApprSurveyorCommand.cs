...
{
    public class ProcessApprSurveyorCommand : LoanApplicationStageProcessRequest, IRequest<ServiceResponse<Unit>>
    {
    }

    public class ProcessApprSurveyorCommandHandler : IRequestHandler<ProcessApprSurveyorCommand, ServiceResponse<Unit>>
    {
        private readonly IGenericRepositoryAsync<LoanApplicationAppraisal> _appraisal;
        private readonly IMapper _mapper;

        public ProcessApprSurveyorCommandHandler(
        ...
        public async Task<ServiceResponse<Unit>> Handle(ProcessApprSurveyorCommand request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                {
                    appraisalData.StageId = LMSUMKMStages.AppraisalApproval.StageId;//Appr Surveyor
