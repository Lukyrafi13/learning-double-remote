        ...
        public async Task<ServiceResponse<ValidasiResponseModel>> Handle(SIKPGetValidasiQuery request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                if (dataCalonDebitur.data != null)
                {
                    ...
                    SIKPResponseData.RfGenderSIKPId = RfGender != null ? RfGender.Id : null; ;
                    SIKPResponseData.RFMaritalSIKPId = RFMarital != null ? RFMarital.Id : null;
                    SIKPResponseData.RFEducationSIKPId = RFEducation != null ? RFEducation.Id : null;
                    SIKPResponseData.RFJobSIKPId = RFJob != null ? RFJob.Id : null; ;
