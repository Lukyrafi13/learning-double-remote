...
// {
//     public class AnalisaKembaliKeIDECommand : AnalisaFind, IRequest<ServiceResponse<AnalisaProsesResponse>>
//     {
//         public string NamaUser { get; set; }
//     }
//     public class AnalisaKembaliKeIDECommandHandler : IRequestHandler<AnalisaKembaliKeIDECommand, ServiceResponse<AnalisaProsesResponse>>
//     {
...
//         public AnalisaKembaliKeIDECommandHandler(
...
//         public async Task<ServiceResponse<AnalisaProsesResponse>> Handle(AnalisaKembaliKeIDECommand request, CancellationToken cancellationToken)
//         {
...
//                 if (Analisa.App.Prospect.Stage.Code == "2.0"){
...
//                 response.Message = "Analisa berhasil dikembalikan ke IDE";
