...
// using NewLMS.Umkm.Data.Dto.MSearches;
...
{
    public interface IDuplicationCheckTask
    {
        Task<bool> DuplicationCheck(Guid SlikRequestId);
    }
    public class DuplicationCheckTask : IDuplicationCheckTask
    {
        ...
        public async Task<bool> DuplicationCheck(Guid slikRequestId)
        {
            try
            {
                ...
                var SlikRequest = await _slikRequest.GetByIdAsync(slikRequestId, "Id", new string[] {
                    "SlikRequestObjects",
                    "App",
                    "App.TipeDebitur",
                }) ?? throw new Exception("Slik Request not found.");
                ...
                SlikRequest.StatusCheckingDuplikasi = 1;
                ...
                {
                    lmsDup.SlikRequestId = slikRequestId;
                ...
                {
                    coreDup.SlikRequestId = slikRequestId;
                ...
                {
                    dhndup.SlikRequestId = slikRequestId;
                ...
                {
                    agunanDup.SlikRequestId = slikRequestId;
                ...
                SlikRequest.StatusCheckingDuplikasi = 2;
                SlikRequest.IsCheckingError = false;
                SlikRequest.CheckingErrorMessage = "";
                await _slikRequest.UpdateAsync(SlikRequest);
            ...
            {
                var SlikRequest = await _slikRequest.GetByIdAsync(slikRequestId, "Id");

                if (SlikRequest != null){
                    SlikRequest.StatusCheckingDuplikasi = 2;
                    SlikRequest.IsCheckingError = true;
                    SlikRequest.CheckingErrorMessage = ex.Message;
