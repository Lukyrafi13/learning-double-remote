...
namespace NewLMS.UMKM.Domain.Migrations
{
    ...
    [Migration("20230102093615_CreateTableLoanApplicationSandiBIs")]
    partial class CreateTableLoanApplicationSandiBIs
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NewLMS.UMKM.Data.ApprovalRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NewLMS.UMKM.Data.Entities.SandiBI", b =>
                {
                    ...
                    b.Property<string>("LBUCollateralType")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");
                    ...
                    b.Property<string>("SIDBMPKRelated")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");
                    ...
                    b.Property<string>("SIDGuaranteeGroup")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");

                    b.Property<string>("SIDGuarantorCode")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");

                    b.Property<string>("SIDPlafondType")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");

                    b.Property<string>("SIDTypeOfInterestRate")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");
                    ...
                    b.HasIndex("SIDGuaranteeGroup");

                    b.HasIndex("SIDGuarantorCode");

                    b.HasIndex("SIDPlafondType");

                    b.HasIndex("SIDTypeOfInterestRate");
            ...
            modelBuilder.Entity("NewLMS.UMKM.Data.Entities.SubmittedFacility", b =>
                {
                    ...
                    b.Property<string>("NikReference")
                        .HasMaxLength(16)
                        .HasColumnType("nvarchar(16)");

                    b.Property<string>("NoBankAccountReference")
                        .HasMaxLength(16)
                        .HasColumnType("nvarchar(16)");
            ...
            modelBuilder.Entity("NewLMS.UMKM.Data.Entities.SandiBI", b =>
                {
                    b.HasOne("NewLMS.UMKM.Data.Entities.RfSandiBI", "RfSandiBICollateralIssuerRating")
                        .WithMany()
                        .HasForeignKey("CollateralIssuerRating");

                    b.HasOne("NewLMS.UMKM.Data.Entities.RfSandiBI", "RfSandiBICompanyRank")
                        .WithMany()
                        .HasForeignKey("CompanyRank");

                    b.HasOne("NewLMS.UMKM.Data.Entities.RfSandiBI", "RfSandiBIDebtorCategory")
                        .WithMany()
                        .HasForeignKey("DebtorCategory");

                    b.HasOne("NewLMS.UMKM.Data.Entities.RfSandiBI", "RfSandiBIDebtorStatus")
                        .WithMany()
                        .HasForeignKey("DebtorStatus");

                    b.HasOne("NewLMS.UMKM.Data.Entities.RfSandiBI", "RfSandiBILBUCollateralType")
                        .WithMany()
                        .HasForeignKey("LBUCollateralType");

                    b.HasOne("NewLMS.UMKM.Data.Entities.RfSandiBI", "RfSandiBILBUCreditTrait")
                        .WithMany()
                        .HasForeignKey("LBUCreditTrait");

                    b.HasOne("NewLMS.UMKM.Data.Entities.RfSandiBI", "RfSandiBILBUCreditType")
                        .WithMany()
                        .HasForeignKey("LBUCreditType");

                    b.HasOne("NewLMS.UMKM.Data.Entities.RfSandiBI", "RfSandiBILBUDebtorClass")
                        .WithMany()
                        .HasForeignKey("LBUDebtorClass");

                    b.HasOne("NewLMS.UMKM.Data.Entities.RfSandiBI", "RfSandiBILBUEconomySector")
                        .WithMany()
                        .HasForeignKey("LBUEconomySector");

                    b.HasOne("NewLMS.UMKM.Data.Entities.RfSandiBI", "RfSandiBILBUUserOrientation")
                        .WithMany()
                        .HasForeignKey("LBUUserOrientation");

                    b.HasOne("NewLMS.UMKM.Data.Entities.RfSandiBI", "RfSandiBILBUUserType")
                        .WithMany()
                        .HasForeignKey("LBUUserType");

                    b.HasOne("NewLMS.UMKM.Data.Entities.RfSandiBI", "RfSandiBIMeasuringCategory")
                        .WithMany()
                        .HasForeignKey("MeasuringCategory");

                    b.HasOne("NewLMS.UMKM.Data.Entities.RfSandiBI", "RfSandiBIPortfolioCategory")
                        .WithMany()
                        .HasForeignKey("PortfolioCategory");

                    b.HasOne("NewLMS.UMKM.Data.Entities.RfSandiBI", "RfSandiBIRatingAgency")
                        .WithMany()
                        .HasForeignKey("RatingAgency");

                    b.HasOne("NewLMS.UMKM.Data.Entities.RfSandiBI", "RfSandiBISIDBMPKRelated")
                        .WithMany()
                        .HasForeignKey("SIDBMPKRelated");

                    b.HasOne("NewLMS.UMKM.Data.Entities.RfSandiBI", "RfSandiBISIDCreditTrait")
                        .WithMany()
                        .HasForeignKey("SIDCreditTrait");

                    b.HasOne("NewLMS.UMKM.Data.Entities.RfSandiBI", "RfSandiBISIDCreditType")
                        .WithMany()
                        .HasForeignKey("SIDCreditType");

                    b.HasOne("NewLMS.UMKM.Data.Entities.RfSandiBI", "RfSandiBISIDDebtorClass")
                        .WithMany()
                        .HasForeignKey("SIDDebtorClass");

                    b.HasOne("NewLMS.UMKM.Data.Entities.RfSandiBI", "RfSandiBISIDEconomySector")
                        .WithMany()
                        .HasForeignKey("SIDEconomySector");

                    b.HasOne("NewLMS.UMKM.Data.Entities.RfSandiBI", "RfSandiBISIDGuaranteeGroup")
                        .WithMany()
                        .HasForeignKey("SIDGuaranteeGroup");

                    b.HasOne("NewLMS.UMKM.Data.Entities.RfSandiBI", "RfSandiBISIDGuarantorCode")
                        .WithMany()
                        .HasForeignKey("SIDGuarantorCode");

                    b.HasOne("NewLMS.UMKM.Data.Entities.RfSandiBI", "RfSandiBISIDPlafondType")
                        .WithMany()
                        .HasForeignKey("SIDPlafondType");

                    b.HasOne("NewLMS.UMKM.Data.Entities.RfSandiBI", "RfSandiBISIDTypeOfInterestRate")
                        .WithMany()
                        .HasForeignKey("SIDTypeOfInterestRate");

                    b.HasOne("NewLMS.UMKM.Data.Entities.RfSandiBI", "RfSandiBISIDUserOrientation")
                        .WithMany()
                        .HasForeignKey("SIDUserOrientation");

                    b.HasOne("NewLMS.UMKM.Data.Entities.RfSandiBI", "RfSandiBISIDUserType")
                        .WithMany()
                        .HasForeignKey("SIDUserType");

                    b.HasOne("NewLMS.UMKM.Data.Entities.LoanApplication", "LoanApplication")
                        .WithOne("SandiBI")
                        .HasForeignKey("NewLMS.UMKM.Data.Entities.SandiBI", "SandiBiId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NewLMS.UMKM.Data.Entities.RfSandiBI", "RfSandiBISourceOfFunds")
                        .WithMany()
                    ...
                    b.Navigation("RfSandiBILBUCollateralType");
                    ...
                    b.Navigation("RfSandiBISIDBMPKRelated");
                    ...
                    b.Navigation("RfSandiBISIDGuaranteeGroup");

                    b.Navigation("RfSandiBISIDGuarantorCode");

                    b.Navigation("RfSandiBISIDPlafondType");

                    b.Navigation("RfSandiBISIDTypeOfInterestRate");
