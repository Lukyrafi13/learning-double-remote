...
namespace NewLMS.Domain.Migrations
{
    ...
    [Migration("20221231065910_AddSomeColumnToSandiBI")]
    partial class AddSomeColumnToSandiBI
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NewLMS.Data.ApprovalRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NewLMS.Data.Entities.DataPK", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NewLMS.Data.Entities.DisbursementLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("NewLMS.Data.Entities.DocumentSp3k", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NewLMS.Data.Entities.InfoLMS", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NewLMS.Data.Entities.LegalSign", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NewLMS.Data.Entities.LoanApplicationApproval", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NewLMS.Data.Entities.LoanApplicationCreditContractTerm", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NewLMS.Data.Entities.LoanApplicationDuplication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NewLMS.Data.Entities.OfferingLetter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NewLMS.Data.Entities.RfBranchDetail", b =>
                {
                    b.Property<string>("BranchId")
                        .HasMaxLength(4)
                        .HasColumnType("nvarchar(4)");
            ...
            modelBuilder.Entity("NewLMS.Data.Entities.RfDimParam", b =>
                {
                    b.Property<string>("Code")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");
            ...
            modelBuilder.Entity("NewLMS.Data.Entities.RfDimParamMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NewLMS.Data.Entities.SandiBI", b =>
                {
                    ...
                    b.Property<string>("BMPKRelation")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");
                    ...
                    b.Property<string>("EconomySecter")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");
                    ...
                    b.Property<string>("LBUPortfolioCategory")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");

                    b.Property<string>("LBUUsageType")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");
                    ...
                    b.Property<string>("UserOrientation")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");

                    b.HasKey("SandiBiId");

                    b.HasIndex("BMPKRelation");

                    b.HasIndex("CollateralIssuerRating");

                    b.HasIndex("CompanyRank");

                    b.HasIndex("CreditClass");

                    b.HasIndex("DebtorCategory");

                    b.HasIndex("DebtorCode");

                    b.HasIndex("DebtorStatus");

                    b.HasIndex("EconomySecter");
                    ...
                    b.HasIndex("LBUPortfolioCategory");

                    b.HasIndex("LBUUsageType");
            ...
            modelBuilder.Entity("NewLMS.Data.Entities.UserFcmToken", b =>
                {
                    b.Property<string>("DeviceId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("NewLMS.Data.Entities.DataPK", b =>
                {
                    b.HasOne("NewLMS.Data.Entities.LoanApplication", "LoanApplication")
                        .WithOne("DataPK")
                        .HasForeignKey("NewLMS.Data.Entities.DataPK", "LoanApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NewLMS.Data.Entities.LegalSign", b =>
                {
                    b.HasOne("NewLMS.Data.Entities.LoanApplication", "LoanApplication")
                        .WithOne("LegalSign")
                        .HasForeignKey("NewLMS.Data.Entities.LegalSign", "LoanApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NewLMS.Data.Entities.SCUser", "SCUserNota")
                        .WithMany()
                        .HasForeignKey("SigningNota");

                    b.HasOne("NewLMS.Data.Entities.SCUser", "SCUserPK")
                        .WithMany()
            ...
            modelBuilder.Entity("NewLMS.Data.Entities.LoanApplication", b =>
                {
                    ...
                    b.HasOne("NewLMS.Data.User", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("NewLMS.Data.Entities.Prospect", b =>
                {
                    b.HasOne("NewLMS.Data.Entities.RfBranch", "RfBookingBranch")
                        .WithMany()
            ...
            modelBuilder.Entity("NewLMS.Data.Entities.RfBranchDetail", b =>
                {
                    b.HasOne("NewLMS.Data.Entities.RfBranch", "RfBranch")
                        ...
                        .HasForeignKey("NewLMS.Data.Entities.RfBranchDetail", "BranchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NewLMS.Data.Entities.RfDimParamMapping", b =>
                {
                    b.HasOne("NewLMS.Data.Entities.RfDimParam", "DIMParam")
                        .WithMany()
            ...
            modelBuilder.Entity("NewLMS.Data.Entities.SandiBI", b =>
                {
                    b.HasOne("NewLMS.Data.Entities.RfSandiBI", "RfSandiBIBMPKRelation")
                        .WithMany()
                        .HasForeignKey("BMPKRelation");
                    ...
                    b.HasOne("NewLMS.Data.Entities.RfSandiBI", "RfSandiBICreditClass")
                        .WithMany()
                        .HasForeignKey("CreditClass");

                    b.HasOne("NewLMS.Data.Entities.RfSandiBI", "RfSandiBIDebtorCategory")
                        .WithMany()
                        .HasForeignKey("DebtorCategory");

                    b.HasOne("NewLMS.Data.Entities.RfSandiBI", "RfSandiBIDebtorCode")
                        .WithMany()
                        .HasForeignKey("DebtorCode");

                    b.HasOne("NewLMS.Data.Entities.RfSandiBI", "RfSandiBIDebtorStatus")
                        .WithMany()
                        .HasForeignKey("DebtorStatus");

                    b.HasOne("NewLMS.Data.Entities.RfSandiBI", "RfSandiBIEconomySector")
                        .WithMany()
                        .HasForeignKey("EconomySecter");
                    ...
                    b.HasOne("NewLMS.Data.Entities.RfSandiBI", "RfSandiBILBUPortfolioCategory")
                        .WithMany()
                        .HasForeignKey("LBUPortfolioCategory");

                    b.HasOne("NewLMS.Data.Entities.RfSandiBI", "RfSandiBILBUUsageType")
                        .WithMany()
                        .HasForeignKey("LBUUsageType");
                    ...
                    b.HasOne("NewLMS.Data.Entities.LoanApplication", "LoanApplication")
                        .WithOne("SandiBI")
                        .HasForeignKey("NewLMS.Data.Entities.SandiBI", "SandiBiId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("NewLMS.Data.Entities.RfSandiBI", "RfSandiBIUserOrientation")
                        .WithMany()
                        .HasForeignKey("UserOrientation");

                    b.Navigation("LoanApplication");

                    b.Navigation("RfSandiBIBMPKRelation");

                    b.Navigation("RfSandiBICollateralIssuerRating");

                    b.Navigation("RfSandiBICompanyRank");

                    b.Navigation("RfSandiBICreditClass");

                    b.Navigation("RfSandiBIDebtorCategory");

                    b.Navigation("RfSandiBIDebtorCode");

                    b.Navigation("RfSandiBIDebtorStatus");

                    b.Navigation("RfSandiBIEconomySector");
                    ...
                    b.Navigation("RfSandiBILBUPortfolioCategory");

                    b.Navigation("RfSandiBILBUUsageType");
                    ...
                    b.Navigation("RfSandiBIUserOrientation");
                });
            ...
            modelBuilder.Entity("NewLMS.Data.Entities.SkkSp3k", b =>
                {
                    b.HasOne("NewLMS.Data.Entities.LoanApplication", "LoanApplication")
                        .WithOne("SkkSp3K")
                        .HasForeignKey("NewLMS.Data.Entities.SkkSp3k", "LoanApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
