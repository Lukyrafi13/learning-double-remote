...
namespace NewLMS.Umkm.Domain.Context
{
    public class UserContext : IdentityDbContext<User, Role, Guid, UserClaim, UserRole, UserLogin, RoleClaim, UserToken>
    {
        ...
        public DbSet<RFStatusTarget> RFStatusTargets { get; set; }
        ...
        public virtual DbSet<RFJenisPermohonan> RFJenisPermohonans { get; set; }
        public DbSet<RFSCORiwayatKreditBJB> RFSCORiwayatKreditBJBs { get; set; }
        public virtual DbSet<RFKategori> RFKategoris { get; set; }
        ...
        public DbSet<RFJenisUsaha> RFJenisUsahas { get; set; }
        ...
        public DbSet<RFJenisUsahaMap> RFJenisUsahaMaps { get; set; }
        ...
        public DbSet<RFJenisUsahaYangDihindari> RFJenisUsahaYangDihindaris { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Prospect>(b =>
            {
                ...
                b.HasOne(e => e.JenisPermohonanKredit)
                    .WithMany()
                    .HasForeignKey(rc => rc.RFJenisPermohonanId)
                    .OnDelete(DeleteBehavior.NoAction);
                ...
                b.HasOne(e => e.Kategori)
                    .WithMany()
                    .HasForeignKey(rc => rc.RFKategoriId)
                    .OnDelete(DeleteBehavior.NoAction);
                ...
                b.HasOne(e => e.KelompokBidangUsaha)
                    .WithMany()
                    .HasForeignKey(rc => rc.RFKelompokUsahaId)
                    .OnDelete(DeleteBehavior.NoAction);

                b.HasOne(e => e.JenisUsaha)
                    .WithMany()
                    .HasForeignKey(rc => rc.RFJenisUsahaId)
                    .OnDelete(DeleteBehavior.NoAction);
            });
