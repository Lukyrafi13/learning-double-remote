...
{
    public class BackToSurveyLoanApplicationAnalystCommand : LoanApplicationProcessStageRequest, IRequest<ServiceResponse<Unit>>
    {
    }

    public class BackToSurveyLoanApplicationAnalystCommandHandler : IRequestHandler<BackToSurveyLoanApplicationAnalystCommand, ServiceResponse<Unit>>
    {
        ...
        public BackToSurveyLoanApplicationAnalystCommandHandler(
        ...
        public async Task<ServiceResponse<Unit>> Handle(BackToSurveyLoanApplicationAnalystCommand request, CancellationToken cancellationToken)
        {
            try
            {
