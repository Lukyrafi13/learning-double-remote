...
{
    public class BackToIdeLoanApplicationAnalystCommand : LoanApplicationProcessStageRequest, IRequest<ServiceResponse<Unit>>
    {
    }

    public class BackToIdeLoanApplicationAnalystCommandHandler : IRequestHandler<BackToIdeLoanApplicationAnalystCommand, ServiceResponse<Unit>>
    {
        ...
        public BackToIdeLoanApplicationAnalystCommandHandler(
        ...
        public async Task<ServiceResponse<Unit>> Handle(BackToIdeLoanApplicationAnalystCommand request, CancellationToken cancellationToken)
        {
            try
            {
