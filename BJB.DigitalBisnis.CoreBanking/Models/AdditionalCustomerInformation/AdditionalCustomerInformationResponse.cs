...
namespace Bjb.DigitalBisnis.CoreBanking.Models.AdditionalCustomerInformation
{
    public class MPOAdditionalCustomerInformationResponse
    {
        [JsonProperty("0")]
        public MPOAdditionalCustomerInformationResponseDetail MPOAdditionalCustomerInformationResponseDetail { get; set; }
    }
    public class MPOAdditionalCustomerInformationResponseDetail
    {
        [JsonProperty("BGEQF")]
