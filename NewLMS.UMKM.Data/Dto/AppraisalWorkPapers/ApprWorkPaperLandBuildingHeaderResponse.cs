...
{
    public class ApprWorkPaperLandBuildingHeaderResponse
    {
        public List<ApprLandBuildingResponse> MarketData { get; set; }
        ...
        public ApprLiquidationLandBuildingResponse LiquidationData { get; set; }
