...
{
    public class ApprShopApartmentResponse
    {
        /* FORM PERHITUNGAN */
        public int? DataNumber { get; set; }
        public SimpleResponse<Guid> DataType { get; set; }
        ...
        public SimpleResponse<Guid> Allotment { get; set; }
        ...
        public SimpleResponse<Guid> Ownership { get; set; }
