...
namespace NewLMS.UMKM.SIKP2
{
    ...
    {
        private const string CONFIGURATION_NAME = "SIKP2";
        public static void AddSIKPAPI2(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddTransient(typeof(ISIKPService2), typeof(SIKPService2));
        }
    }
}